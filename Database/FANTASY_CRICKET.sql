...
Date: 2015-05-19 01:06:06
*/


-- ----------------------------
-- Table structure for "FANTASY_CRICKET"."admin"
-- ----------------------------
DROP TABLE "FANTASY_CRICKET"."admin";
CREATE TABLE "FANTASY_CRICKET"."admin" (
...
-- Records of admin
-- ----------------------------
INSERT INTO "FANTASY_CRICKET"."admin" VALUES ('Admin', '21232f297a57a5a743894a0e4a801fc3');
INSERT INTO "FANTASY_CRICKET"."admin" VALUES ('Saiful', '1bd413de70f32142f4a33a94134c5690');
INSERT INTO "FANTASY_CRICKET"."admin" VALUES ('Neamul', '6ffc599b0cdaa13529668e6f9da41792');
...
"team1_total_runs" NUMBER DEFAULT 0  NULL ,
"team1_wickets" NUMBER DEFAULT 0  NULL ,
"team1_balls" NUMBER DEFAULT 0  NULL ,
"team2_total_runs" NUMBER DEFAULT 0  NULL ,
"team2_wickets" NUMBER DEFAULT 0  NULL ,
"team2_balls" NUMBER DEFAULT 0  NULL ,
"is_started" NUMBER DEFAULT 0  NULL ,
"is_complete" NUMBER DEFAULT 0  NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
-- Records of match
-- ----------------------------
INSERT INTO "FANTASY_CRICKET"."match" VALUES ('4', TO_TIMESTAMP(' 2012-08-19 14:40:11:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), '2', '3', null, '1', '235', '10', '283', '238', '6', '240', '1', '0');
INSERT INTO "FANTASY_CRICKET"."match" VALUES ('21', TO_TIMESTAMP(' 2015-05-19 14:40:11:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), '1', '3', null, '1', '0', '0', '0', '0', '0', '0', '0', '0');
INSERT INTO "FANTASY_CRICKET"."match" VALUES ('22', TO_TIMESTAMP(' 2015-05-22 14:40:11:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), '1', '2', null, '1', '0', '0', '0', '0', '0', '0', '0', '0');
...
"phase_name" VARCHAR2(50 BYTE) NULL ,
...
-- Records of phase
-- ----------------------------
INSERT INTO "FANTASY_CRICKET"."phase" VALUES ('1', 'Round Of 32', TO_TIMESTAMP(' 2015-05-20 10:41:04:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), TO_TIMESTAMP(' 2015-05-25 11:41:11:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), '10', '1', '0', '0');
INSERT INTO "FANTASY_CRICKET"."phase" VALUES ('2', 'Group Stage', TO_TIMESTAMP(' 2015-05-05 11:41:41:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), TO_TIMESTAMP(' 2015-05-17 11:41:47:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), '40', '1', '1', '0');
INSERT INTO "FANTASY_CRICKET"."phase" VALUES ('3', 'Round Of 16', TO_TIMESTAMP(' 2015-05-27 11:42:14:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), TO_TIMESTAMP(' 2015-05-29 11:42:21:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), '6', '1', '0', '0');
INSERT INTO "FANTASY_CRICKET"."phase" VALUES ('5', 'Round Of 8', TO_TIMESTAMP(' 2015-06-03 11:42:47:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), TO_TIMESTAMP(' 2015-06-08 11:42:58:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), '6', '1', '0', '0');
INSERT INTO "FANTASY_CRICKET"."phase" VALUES ('6', 'Semi Final', TO_TIMESTAMP(' 2015-06-25 11:43:31:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), TO_TIMESTAMP(' 2015-05-27 11:43:47:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), '6', '1', '0', '0');
INSERT INTO "FANTASY_CRICKET"."phase" VALUES ('7', 'Final', TO_TIMESTAMP(' 2015-06-29 11:44:02:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), TO_TIMESTAMP(' 2015-06-27 12:44:08:000000', 'YYYY-MM-DD HH24:MI:SS:FF6'), '6', '1', '0', '0');
...
"player_id" NUMBER NOT NULL ,
"match_id" NUMBER NOT NULL ,
"runs_scored" NUMBER DEFAULT 0  NULL ,
"balls_played" NUMBER DEFAULT 0  NULL ,
"fours" NUMBER DEFAULT 0  NULL ,
"sixes" NUMBER DEFAULT 0  NULL ,
"wickets_taken" NUMBER DEFAULT 0  NULL ,
"balls_bowled" NUMBER DEFAULT 0  NULL ,
"runs_conceded" NUMBER DEFAULT 0  NULL ,
"maiden_overs" NUMBER DEFAULT 0  NULL ,
"catches" NUMBER DEFAULT 0  NULL ,
"stumpings" NUMBER DEFAULT 0  NULL ,
"run_outs" NUMBER DEFAULT 0  NULL ,
"total_points" NUMBER DEFAULT 0  NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
"jersy_image" VARCHAR2(255 BYTE) NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
-- Records of team
-- ----------------------------
INSERT INTO "FANTASY_CRICKET"."team" VALUES ('1', 'Test Team', null);
INSERT INTO "FANTASY_CRICKET"."team" VALUES ('2', 'Test Team 2', null);
INSERT INTO "FANTASY_CRICKET"."team" VALUES ('3', 'Test Team 3', null);
...
-- ----------------------------
INSERT INTO "FANTASY_CRICKET"."team_tournament" VALUES ('1', '1', '1');
INSERT INTO "FANTASY_CRICKET"."team_tournament" VALUES ('2', '2', '1');
INSERT INTO "FANTASY_CRICKET"."team_tournament" VALUES ('3', '3', '1');
...
"end_date" DATE NULL ,
"is_active" NUMBER DEFAULT 0  NULL ,
...
-- ----------------------------
INSERT INTO "FANTASY_CRICKET"."tournament" VALUES ('1', 'Asian Nations Cup', null, null, '1', null, null);

-- ----------------------------
-- Table structure for "FANTASY_CRICKET"."user_inter_phase_transfer"
-- ----------------------------
DROP TABLE "FANTASY_CRICKET"."user_inter_phase_transfer";
CREATE TABLE "FANTASY_CRICKET"."user_inter_phase_transfer" (
"user_inter_phase_id" NUMBER NOT NULL ,
"user_id" NUMBER NOT NULL ,
"inter_phase_id" NUMBER NOT NULL ,
"transfers_made" NUMBER DEFAULT 0  NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
-- ----------------------------
-- Records of user_inter_phase_transfer
-- ----------------------------
...
"total_point" NUMBER DEFAULT 0  NULL 
)
LOGGING
NOCOMPRESS
NOCACHE
...
-- ----------------------------
-- Table structure for "FANTASY_CRICKET"."user_phase_transfer"
-- ----------------------------
DROP TABLE "FANTASY_CRICKET"."user_phase_transfer";
CREATE TABLE "FANTASY_CRICKET"."user_phase_transfer" (
"user_phase_id" NUMBER NOT NULL ,
"user_id" NUMBER NOT NULL ,
"phase_id" NUMBER NOT NULL ,
"transfers_made" NUMBER DEFAULT 0  NULL 
)
...
-- ----------------------------
-- Records of user_phase_transfer
-- ----------------------------
...
INSERT INTO "FANTASY_CRICKET"."userInfo" VALUES ('64', 'Hello', 'hl@gmail.com', '7215ee9c7d9dc229d2921a40e899ec5f', null, null);
...
INSERT INTO "FANTASY_CRICKET"."userInfo" VALUES ('84', 'Test ID 1', 'test@ymail.com', 'c4ca4238a0b923820dcc509a6f75849b', null, null);
INSERT INTO "FANTASY_CRICKET"."userInfo" VALUES ('104', 'Md. Saiful Islam', 'saiful.11722@gmail.com', '7215ee9c7d9dc229d2921a40e899ec5f', null, 'Bangladesh');
...
-- ----------------------------
-- Sequence structure for "FANTASY_CRICKET"."USER_INTER_PHASE_ID_COUNTER"
-- ----------------------------
DROP SEQUENCE "FANTASY_CRICKET"."USER_INTER_PHASE_ID_COUNTER";
CREATE SEQUENCE "FANTASY_CRICKET"."USER_INTER_PHASE_ID_COUNTER"
 INCREMENT BY 1
 MINVALUE 1
 MAXVALUE 999999999999999999999999999
 START WITH 1
...
-- ----------------------------
-- Sequence structure for "FANTASY_CRICKET"."USER_PHASE_ID_COUNTER"
-- ----------------------------
DROP SEQUENCE "FANTASY_CRICKET"."USER_PHASE_ID_COUNTER";
CREATE SEQUENCE "FANTASY_CRICKET"."USER_PHASE_ID_COUNTER"
 INCREMENT BY 1
 MINVALUE 1
 MAXVALUE 999999999999999999999999999
 START WITH 1
...
-- ----------------------------
-- Checks structure for table "FANTASY_CRICKET"."admin"
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."admin" ADD CHECK ("admin_id" IS NOT NULL);
ALTER TABLE "FANTASY_CRICKET"."admin" ADD CHECK ("password" IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table "FANTASY_CRICKET"."admin"
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."admin" ADD PRIMARY KEY ("admin_id");
...
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."player_match_point" ADD PRIMARY KEY ("player_id", "match_id");
...
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."player_tournament" ADD PRIMARY KEY ("player_id", "tournament_id");
...
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."team_tournament" ADD PRIMARY KEY ("team_id", "tournament_id");
...
-- ----------------------------
-- Uniques structure for table "FANTASY_CRICKET"."tournament"
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."tournament" ADD UNIQUE ("tournament_name");
...
-- ----------------------------
-- Indexes structure for table user_inter_phase_transfer
-- ----------------------------

-- ----------------------------
-- Triggers structure for table "FANTASY_CRICKET"."user_inter_phase_transfer"
-- ----------------------------
CREATE OR REPLACE TRIGGER "FANTASY_CRICKET"."USER_INTER_PHASE_AI" BEFORE INSERT ON "FANTASY_CRICKET"."user_inter_phase_transfer" REFERENCING OLD AS "OLD" NEW AS "NEW" FOR EACH ROW ENABLE
BEGIN
					:NEW."user_inter_phase_id" := user_inter_phase_id_counter.nextval;
			end;
-- ----------------------------
-- Checks structure for table "FANTASY_CRICKET"."user_inter_phase_transfer"
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."user_inter_phase_transfer" ADD CHECK ("user_inter_phase_id" IS NOT NULL);
ALTER TABLE "FANTASY_CRICKET"."user_inter_phase_transfer" ADD CHECK ("user_id" IS NOT NULL);
ALTER TABLE "FANTASY_CRICKET"."user_inter_phase_transfer" ADD CHECK ("inter_phase_id" IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table "FANTASY_CRICKET"."user_inter_phase_transfer"
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."user_inter_phase_transfer" ADD PRIMARY KEY ("user_id", "inter_phase_id");
...
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."user_match_team_player" ADD PRIMARY KEY ("user_match_team_id", "player_id");

-- ----------------------------
-- Indexes structure for table user_phase_transfer
-- ----------------------------

-- ----------------------------
-- Triggers structure for table "FANTASY_CRICKET"."user_phase_transfer"
-- ----------------------------
CREATE OR REPLACE TRIGGER "FANTASY_CRICKET"."USER_PHASE_AUTO_INCREMENT" BEFORE INSERT ON "FANTASY_CRICKET"."user_phase_transfer" REFERENCING OLD AS "OLD" NEW AS "NEW" FOR EACH ROW ENABLE
BEGIN
					:NEW."user_phase_id" := user_phase_id_counter.nextval;
			end;
-- ----------------------------
-- Checks structure for table "FANTASY_CRICKET"."user_phase_transfer"
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."user_phase_transfer" ADD CHECK ("user_phase_id" IS NOT NULL);
ALTER TABLE "FANTASY_CRICKET"."user_phase_transfer" ADD CHECK ("user_id" IS NOT NULL);
ALTER TABLE "FANTASY_CRICKET"."user_phase_transfer" ADD CHECK ("phase_id" IS NOT NULL);

-- ----------------------------
-- Primary Key structure for table "FANTASY_CRICKET"."user_phase_transfer"
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."user_phase_transfer" ADD PRIMARY KEY ("user_id", "phase_id");
...
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."user_tournament" ADD PRIMARY KEY ("user_id", "tournament_id");
...
ALTER TABLE "FANTASY_CRICKET"."inter_phase" ADD FOREIGN KEY ("next_phase_id") REFERENCES "FANTASY_CRICKET"."phase" ("phase_id");
...
ALTER TABLE "FANTASY_CRICKET"."team_tournament" ADD FOREIGN KEY ("tournament_id") REFERENCES "FANTASY_CRICKET"."tournament" ("tournament_id");

-- ----------------------------
-- Foreign Key structure for table "FANTASY_CRICKET"."user_inter_phase_transfer"
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."user_inter_phase_transfer" ADD FOREIGN KEY ("inter_phase_id") REFERENCES "FANTASY_CRICKET"."inter_phase" ("inter_phase_id");
ALTER TABLE "FANTASY_CRICKET"."user_inter_phase_transfer" ADD FOREIGN KEY ("user_id") REFERENCES "FANTASY_CRICKET"."userInfo" ("user_id");
...
-- ----------------------------
-- Foreign Key structure for table "FANTASY_CRICKET"."user_phase_transfer"
-- ----------------------------
ALTER TABLE "FANTASY_CRICKET"."user_phase_transfer" ADD FOREIGN KEY ("phase_id") REFERENCES "FANTASY_CRICKET"."phase" ("phase_id");
ALTER TABLE "FANTASY_CRICKET"."user_phase_transfer" ADD FOREIGN KEY ("user_id") REFERENCES "FANTASY_CRICKET"."userInfo" ("user_id");
